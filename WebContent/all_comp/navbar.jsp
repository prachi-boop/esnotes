...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		</a> <a href="LogoutServlet" class="btn btn-light my-2 my-sm-0 mr-3"
			type="submit"> <i class="fa fa-user" aria-hidden="true"></i>LogOut
		</a> 
    ...
    <div class="modal-content">
      ...
      <div class="container text-center">
		...
		%>
			...
			</a> <a href="register.jsp" class="btn btn-light my-2 my-sm-0 mr-3"
			type="submit"> <i class="fa fa-user" aria-hidden="true"></i>Register
			</a>
		<%
		} %>
